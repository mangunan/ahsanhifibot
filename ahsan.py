...
def Link(link, chat_id, quality, msg):
    ...
    try:
       ...
       logging.warning(a)
       logging.info(link)
       sendMessage(chat_id, translate(languag[chat_id], "OPS :( Something went wrong please contact @ahsancode to explain the issue."))
    try:
       if done == 1:
